  ...
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      describe "generate" do
        ...
        it "must properly attribute mixins" do
          ...
          @project.require_real_gem("byebug")
        ...
        it "must not generate RBI for constants defined in other gems" do
          foo = mock_gem("foo", "0.3.0") do
          ...
          out = @project.tapioca("gem foo bar").out

          assert_includes(out, "Compiled foo")
          assert_includes(out, "Compiled bar")

          assert_project_file_equal("sorbet/rbi/gems/foo@0.3.0.rbi", <<~RBI)
            # typed: true
